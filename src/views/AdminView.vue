  ...
  <div class="admin">
    ...
    <div class="admin-section">
      ...
      <div v-else class="no-week">
        ...
        <button :disabled="loading" @click="createNewWeek">
          Create New Week
        </button>
      </div>
    </div>
    ...
    <div class="admin-section">
      <h2>Add Pick</h2>
      <form class="add-pick-form" @submit.prevent="handleAddPick">
    ...
    <div class="admin-section">
      ...
      <div v-if="gameStore.currentWeek" class="end-week">
        ...
        <button :disabled="loading || !selectedWinner" @click="handleEndWeek">
...
const handleEndWeek = async () => {
  ...
  error.value = '';
  try {
    await axios.put(`/api/weeks/week-details?id=${gameStore.currentWeek.id}`, {
